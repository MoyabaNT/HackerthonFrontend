import React, { useContext, useEffect, useState } from 'react';
   ...
   const DashBoard = () => {
     ...
     useEffect(() => {
       ...
       const unsubscribeTaxis = onSnapshot(collection(db, 'dispatchedTaxis'), (snapshot) => {
         setTaxisDispatched(snapshot.size); // Update count in real-time
       }, (error) => {
